...
{
    public class ProfileHeaderViewComponent : BaseViewComponent
    {
        private readonly UserManager<User> _userManager;
        private readonly SignInManager<User> _signInManager;
        public ProfileHeaderViewComponent(UserManager<User> userManager, SignInManager<User> signInManager)
        {
